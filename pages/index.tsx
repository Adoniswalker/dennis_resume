                    ...
                    <>
                        <div className={styles.container}>
                            <div className="relative flex items-center justify-between flex-wrap bg-white p-3">
                                ...
                                <div className="absolute inset-y-0 left-0 flex items center block sm:hidden">
                                    <Disclosure.Button
                                        className="items-center px-3 py-2 border rounded border-teal-400  hover:text-white hover:border-white">
                                ...
                                <div
                                    className="flex-1 sm:flex-none flex justify-center sm:items-stretch sm:justify-start font-black">
                                    <div className="flex-shrink-0 flex items-center">DN</div>
                                </div>
                                ...
                                <div className="block flex items-center">
                                    <a href="https://www.linkedin.com/in/dennis-koech-ngeno/"
                                       className="mr-2"><FiGithub/></a>
